...
#movies = []
#with open("C:\\Users\\Hello\\Desktop\\Data science\\data science\\assignments\\Association rules\\datasets\\mymovies.csv",sep=",")as f:movies = f.read()
movies=pd.read_csv("C:\\Users\\Hello\\Desktop\\Data science\\data science\\assignments\\Association rules\\datasets\\my_movies_ori.csv",sep=",")
...
data_dummies = pd.read_csv("C:\\Users\\Hello\\Desktop\\Data science\\data science\\assignments\\Association rules\\datasets\\my_movies_ori.csv")
